...
//Find a random movie for the banner
  ...
  useEffect(() => {
    axios
        .get(API_REQUESTS.requestPopular)
        .then(response => (
    ...
    <div className='w-full h-[550px]'>
        <div className='w-full h-full'>
            ...
            <div className='text-white px-6 absolute top-[20%] py-4'>
                <h1 className='text-3xl md:text-5xl font-bold'>{randomMovie?.original_title}</h1>
                <div className='py-4'>
                ...
                <p className='text-sm md:max-w-[70%] lg:max-w-[50%] xl:max-w-[40%]'>
